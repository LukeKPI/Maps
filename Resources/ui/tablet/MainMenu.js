...
function MainMenu() {
    ...
    var MenuItem = function(textId, text2Id, openWin) {
        ...
        menuItem.addEventListener('singletap', function(e) {
            ...
            menuItem.children[1].children[0].color = '#ecf1b4';
            menuItem.children[1].children[1].color = '#ecf1b4';
            Ti.App.fireEvent(openWin);

            setTimeout(function() {
                menuItem.backgroundImage = '/images/i1_0/menu_row.png';
                menuItem.children[1].children[0].color = '#fff';
                menuItem.children[1].children[1].color = '#fff';
            }, 200);
        });
